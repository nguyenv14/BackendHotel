    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form id="form-room" action="{{ 'update-room' }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" value="{{ $room_old['room_id'] }}" name="room_id">
                    <input type="hidden" value="{{ $room_old['hotel_id'] }}" name="hotel_id">
                    <div class="form-group">
                        <label for="">Tên Phòng</label>
                        <input id="name_room" type="text" name="room_name" value="{{ $room_old['room_name'] }}" class="form-control" id="" placeholder="Tên Phòng" >
                    ...
                    <div class="form-group">
                        ...
                        <input id="acreage_room" type="text" name="room_acreage" class="form-control"
                            placeholder="Diện Tích" value="{{ $room_old['room_acreage'] }}">
                        <span class="text-danger form-message"></span>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="row mt-2" style="overflow-x: auto; padding-left: 30px;">
                            @php
                                $selectedFacilities = is_array($room_old->facilities) ? $room_old->facilities : [];
                            @endphp
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" 
                                            ...
                                            {{ in_array($facility->facilitiesroom_id, $selectedFacilities) ? 'checked' : '' }}>
