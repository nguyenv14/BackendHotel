...
@section('manager_hotel')
    ...
    <div style="margin-top: 20px;">
        <div class="template-demo" style="display: flex; flex-wrap: wrap; gap: 10px; align-items: center;">
            ...
            @if($order_full->order_status == \App\Http\Enums\OrderStatus::CHECK_IN)
            ...
            @if($order_full->order_status == \App\Http\Enums\OrderStatus::CHECK_OUT)
            ...
            {{-- Form Hoàn Thành (khi status = CHECK_OUT) - không cần nữa vì checkout đã tự động complete --}}
