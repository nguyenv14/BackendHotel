...
@section('admin_content')
        ...
        <div class="card">
            <div class="card-body">
                <div style="display: flex;justify-content: space-between">
                    <div class="card-title col-sm-6">Bảng Danh Sách Slider</div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-2">
                        ...
                        <div class="input-group">
                            <a style="text-decoration: none" href="{{ URL::to('admin/slider/list-deleted-slider') }}">
    ...
    <script>
        ...
        function load_count_bin() {
            $.ajax({
                url: '{{ url('/admin/slider/count-bin') }}',
                method: 'GET',
                success: function(data) {
                    if (data == 0) {
    ...
    <script>
        $('#search').keyup(function() {
            ...
            $.ajax({
                url: '{{ url('/admin/slider/search-slider') }}',
                method: 'GET',
                data: {
        ...
        $(document).on('click', '.update-status', function() {
            ...
            $.ajax({
                ...
                url: '{{ url('/admin/slider/update-status-slider') }}',
                method: 'POST',
                data: {
                    slider_id: item_id,
                    slider_status: item_status,
                },
                success: function(data) {
                    getPosts(notePage);
                    if (item_status == 1) {
