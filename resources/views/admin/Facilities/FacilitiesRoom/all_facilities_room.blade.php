...
@section('admin_content')
        ...
        <div class="card">
            <div class="card-body">
                <div style="display: flex;justify-content: space-between">
                    <div class="card-title col-sm-6">Bảng Danh Sách Tiện Ích Phòng</div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-2">
                        ...
                        <div class="input-group">
                            <a style="text-decoration: none" href="{{ URL::to('admin/hotel/facilities/room/list-deleted-room-facilities') }}">
    ...
    <script>
        ...
        function getPosts(page) {
            $.ajax({
                url: '{{ url('admin/hotel/facilities/room/load-room-facilities?page=') }}' + page,
                method: 'get',
                data: {

                },
                success: function(data) {
                    $('#load_facilities_room').html(data);
                },
                error: function() {
                    alert("Bug Huhu :<<");
                }
        ...
        function load_count_bin() {
            $.ajax({
                url: '{{ url('admin/hotel/facilities/room/count-bin') }}',
                method: 'GET',
                success: function(data) {
                    if (data == 0) {
    ...
    <script>
        $('#search').keyup(function() {
            ...
            $.ajax({
                url: '{{ url('admin/hotel/facilities/room/search-room-facilities') }}',
                method: 'GET',
                data: {
        ...
        $(document).on('click', '.update-status', function() {
            ...
            $.ajax({
                ...
                url: '{{ url('admin/hotel/facilities/room/update-status-room-facilities') }}',
                method: 'POST',
                data: {
                   facilitiesroom_id: item_id,
                   facilitiesroom_status: item_status,
                },
                success: function(data) {
                    getPosts(notePage);
                    if (item_status == 1) {
        ...
        function move_to_bin(item_id) {
            $.ajax({
                ...
                url: '{{ url('admin/hotel/facilities/room/delete-room-facilities') }}',
                method: 'POST',
                data: {
                   facilitiesroom_id: item_id,
                },
