...
@section('admin_content')
    <div class="page-header">
        <h3 class="page-title">
            ...
            </span> Quản Lý Phí Dịch Vụ Khách Sạn
        </h3>
        ...
        <div class="card">
            <div class="card-body">
                <div style="display: flex;justify-content: space-between">
                    <div class="card-title col-sm-6">Bảng Danh Sách Phí Dịch Vụ Khách Sạn</div>
                    <div class="col-sm-3">
                        <div class="input-group">
                            <input id="search" type="text" class="form-control" name="search"
                                placeholder="Tìm Kiếm ID Hoặc Tên Phí Dịch Vụ Khách Sạn">
                    ...
                    <div class="col-sm-2">
                        ...
                        <div class="input-group">
                            <a style="text-decoration: none" href="{{ URL::to('admin/servicecharge/list-deleted-service-charge') }}">
    ...
    <script>
        ...
        function getPosts(page) {
            $.ajax({
                url: '{{ url('admin/servicecharge/load-service-charge?page=') }}' + page,
                method: 'get',
                data: {

                },
                success: function(data) {
                    $('#load_service_charge').html(data);
                },
                error: function() {
                    alert("Bug Huhu :<<");
                }
        ...
        function load_count_bin() {
            $.ajax({
                url: '{{ url('admin/servicecharge/count-bin') }}',
                method: 'GET',
                success: function(data) {
                    if (data == 0) {
    ...
    <script>
        $('#search').keyup(function() {
            ...
            $.ajax({
                url: '{{ url('admin/servicecharge/search-service-charge') }}',
                method: 'GET',
                data: {
        ...
        $(document).on('click', '.btn-delete-item', function() {
            ...
            message_toastr("success", 'Xác Nhận Xóa Phí Dịch Vụ Khách Sạn ID ' + item_id +
        ...
        function move_to_bin(item_id) {
            $.ajax({
                ...
                url: '{{ url('admin/servicecharge/delete-service-charge') }}',
                method: 'POST',
                data: {
                   servicecharge_id: item_id,
                },
                success: function(data) {
                    $(".loading").css({
                        "display": "none"
                    ...
                    load_count_bin();
                    getPosts(notePage);
                    message_toastr("success", 'Phí Dịch Vụ Khách Sạn ID ' + item_id + ' Đã Được Đưa Vào Thùng Rác !');
                },
                error: function() {
                    $(".loading").css({
                        "display": "none"
